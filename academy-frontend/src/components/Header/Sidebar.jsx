...
const Sidebar = ({ isAuthenticated = false, user }) => {
  ...
  const Menus = [
    ...
    { title: "Browse properties", src: <AiOutlineSearch />, link: "/courses" },
    { title: "Feedback", src: <AiOutlineSend />, link: "/request" },
  ...
  const adminMenus = [
    ...
    { title: "Properties", src: <GiConvergenceTarget />, link: "/admin/courses" },
  ];
